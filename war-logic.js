window.warRoom = function() {
    return {
        ...
        copyScoutPrompt() { 
            const prompt = `Convert the following messy OCR text into a CLEAN JSON array: [{"tag": "TAG", "name": "Name", "stash": 12345678}]. Rules: remove dots/commas from stash. OCR Data: \n${this.importData}`;
