    ...
    return {
        ...
        updateClock() {
            ...
            if (cetTime < this.seasonStart) {
                ...
                this.phaseAction = "Next Battle Window Countdown";
            }
        },
        ...
        async fetchData() {
            ...
            try {
                ...
                // Mapping Supabase View columns to Logic variables
        ...
        get factionData() {
            try {
                ...
                return this.alliances.map(a => {
                    ...
                    const hoursSince = Math.max(0, (now - new Date(last.timestamp)) / 3600000);
