    ...
    return {
        ...
        updateClock() {
            ...
            if (cetTime < this.seasonStart) {
                ...
                this.currentPhase = curr.n; this.phaseAction = "Declaration status: Group-Locked.";
        ...
        // --- DATA FETCHING (MATCHED TO SUPABASE COLUMNS) ---
        async fetchData() {
            this.loading = true;
            try {
                ...
                // Correctly map View columns (player_name, player_thp) to Logic variables
